...
import { deleteUnitMeasurement }  from '../../../api/catalog/unitMeasurement';
...
const UnitMeasurement = () => {
   ...
   const [editData, setEditData] = useState({});
    ...
    useEffect(() => {setTitle('Unidades de medida')}, []);
  ...
  const deleteRecord = (id) => {
    deleteUnitMeasurement(id).then(() => openNotification('success'));
  };
